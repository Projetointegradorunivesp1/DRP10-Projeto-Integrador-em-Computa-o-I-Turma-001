...
<table width="720" border=0 >
	<tr>
		<td>
			<div class="caixa1">
				<?php echo "<font color=#0f0> Escola: </font> " . $y . " <br> " . "<font color=#0f0>Período: </font>" .  $w .  " <br> " . "<font color=#0f0>Ano Letivo: </font>".  substr($x,0, 4) ; ?>
				...
				?>
					...
					<table width="720" class="caixa5" border=0 >
						<tr >
							...
							?>
							<?php } else { echo "<META  HTTP-EQUIV=REFRESH CONTENT='0; URL=pisem3k054.php?ide=$idescodit&idb=$idbimmedit&ida=$x'>" ; } ;
