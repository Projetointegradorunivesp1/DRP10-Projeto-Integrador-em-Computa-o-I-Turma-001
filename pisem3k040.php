...
<div class="caixa3">
<form action="pisem3k039fx.php" name="form" method="post" enctype="multipart/form-data">
...
<table width="720" border="0" >
  <tr>
	...
	<strong><font size="+2" color="#FFFF26"  ><?php echo $editarcadoalunos ; ?> id Cadastro: <font size="-2">[<?php echo $idu37 ; ?>]</font></font></strong>
	</td>
	</tr>
	<td>
    <center>
...
<option>2012</option>
  ...
  <option>1930</option>
	  ...
	  <tr>
		...
		<td>
		<div align="right"><input type="submit" name="button" id="button" value="Excluir Cadastro" /><div align="left"></div>
		</td>
		<td>
		</td>
    </table>
