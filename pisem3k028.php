...
<div class="caixa2">
<form action="pisem3k029fx.php?id=<?php echo $id_get ; ?>&ide=<?php echo $ide_get ; ?>" name="form" method="post" enctype="multipart/form-data">
...
<table width="720" border="0" >
  <tr>
	...
	<strong><?php echo $edicsala2w ; ?></strong>
	</td>
	</tr>
	<td>
	<strong><?php echo $serieano ; ?> </strong>
	     ...
	     &nbsp; &nbsp;&nbsp;<strong> Turma:</strong> 
			...
			<br />	<br />	
			<div align="right"><input type="submit" value="<?php echo $concluiredit2s ; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;</div>	
	</td>
	</tr>
</table>
</form>
