...
<table border="0" width="720">
	...
	<a href="pisem3k052b1.php?idp=<?php echo $id_idprof ; ?>&iddis=<?php echo $id_dis ; ?>&idesc=<?php echo $id_idesco ; ?>"> 1B </a> 
	...
	<a href="pisem3k052b4.php?idp=<?php echo $id_idprof ; ?>&iddis=<?php echo $id_dis ; ?>&idesc=<?php echo $id_idesco ; ?>"> <font size="+3"><strong>4B</strong> </font> </a>
							</td>
						</tr>
					</table>
					</div>
