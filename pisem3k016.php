...
<table width="720" border="0" cellpadding="20">
	<tr>
		<td>
		<div class="caixa1"> Editando dados da escola: [<?php echo $id_escola ; ?>] <?php echo $nome_escola ; ?> </div>
		<br>
		<form action="pisem3k018fx.php" name="form" method="post" enctype="multipart/form-data">   
		 <table  border="0"  width="720">
		  <tr>
			<td  align="right" ><strong> Escola </strong> </td>
		
			<td  colspan="2" align="left"> <label> <input name="escola" type="text" id="escola" size="83" value="<?php echo $nome_escola ; ?>" /></label>
		  ...
		  <tr>
			...
			<td><input type="text" name="endereco"  size="83" value="<?php echo $nome_endereco ; ?>"/></td>
		</tr>
		<tr>
			<td align="right" valign="top"> <b> <label > <font size="-1"><?php echo $rsocial ?></font></label></b></td>
			<td><input type="text" name="rsocial"  size="83" value="<?php echo $nome_razaoa ; ?>" /></td>
		</tr>
		<tr>
			<td align="right" valign="top"> <b> <label > CNPJ </label></b></td>
			<td><input type="text" name="cnpj"  size="83" value="<?php echo $nome_cnpj ; ?>"/></td>
		</tr>
		<tr>
			<td align="right" valign="top"> <b> <label > Telefones </label></b></td>
			<td><input type="text" name="Telefones" id="escola"  size="83" value="<?php echo $nome_tel1 ; ?>"/> </td>
		</tr>
		<tr>
			<td>
			</td>
		  ...
		  <tr>
			<td align=right>  </td>
			<td align="right"> <br><input type="submit" value="Confirmar Edição" /></td>
		  </tr>
			</table>
