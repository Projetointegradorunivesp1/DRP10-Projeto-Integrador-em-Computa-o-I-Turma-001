...
<table width="720" border="0" >
  <tr>
	...
	<form action="pisem3k025fx.php" name="form" method="post" enctype="multipart/form-data">
	<?php $sqlescola = mysqli_query($mysqli,"SELECT * FROM `pisno_b0002` where id='$id_anoletivo'") or die("Erro");
		...
		<div class="caixa3"> <strong>Excluir Ano Letivo em</strong>: <?php echo $escola ; ?> -
			  ...
			  <input type="submit" value="<?php echo $exclconfirm2  ; ?>" />
		</form>
		<?php
					}
					?>
