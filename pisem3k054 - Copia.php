...
<?php 
$sql_escola = mysqli_query($mysqli,"SELECT * FROM `pisno_b0001` where id='$ideget'");
...
<table width="720" border=0 >
	<tr>
		<td>
			<div class="caixa1">
				<?php echo "<font color=#0f0> Escola: </font> " . $y . " <br> " . "<font color=#0f0>Período: </font>" .  $w .  " <br> " . "<font color=#0f0>Ano Letivo: </font>".  substr($x,0, 5) ; ?>
