...
<?php 
	...
	<?php 
	$sql_profs = mysqli_query($mysqli,"SELECT * FROM `pisno_b0004` where prof = '$id_user'");
	...
	<td width="" align="">
				...
				$id_turma = $linha_sert['id'];
				$nome_sala = $linha_sert['ecolaridade'];
	...
	<td>
		<a href="pisem3k052.php?idp=<?php echo $id_idprof ; ?>&iddis=<?php echo $id_dis ; ?>&idesc=<?php echo $id_idesco ; ?>&idt=<?php echo $id_turma ; ?>">
